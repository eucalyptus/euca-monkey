...
def main():
	...
	print
	print "===== EUCA MONKEY WEBSERVICE INSTALLER ======"
	print

#	parser = OptionParser()
#	parser.add_option("-t", "--instance-type", dest="instance", help="linux distro instance type: ['centos6', 'rhel6']")
...
#	if options.instance is "centos6" or options.instance is "rhel6" :
	...
	print
	print "===== EUCA MONKEY WEBSERVICE INSTALLER : DONE ====="
	print
