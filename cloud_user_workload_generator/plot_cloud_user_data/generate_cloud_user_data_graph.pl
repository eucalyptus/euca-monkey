...
my $scr_name = "gnuplot_script_cloud_user_input.script";
my $data_name = "cloud_user_input.log";
my $png_name = "cloud_user_input.png";
...
print SCR "set title \"EUCA MONKEY: CLOUD USER INPUT\"\n";
